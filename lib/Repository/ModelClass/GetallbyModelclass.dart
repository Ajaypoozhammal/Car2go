class GetallbyModelclass {
  ...
  GetallbyModelclass.fromJson(dynamic json) {
  ...
  static List<GetallbyModelclass> listFromJson(List<dynamic> json) {
    return json == null
        ? []
        : json.map((value) => GetallbyModelclass.fromJson(value)).toList();
  }
